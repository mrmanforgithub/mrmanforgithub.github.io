...
class Cursor {
	...
	create() {
		...
		// 这里改变鼠标指针的颜色 由svg生成
		// this.scr.innerHTML = `* {cursor: url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8' width='12px' height='12px'><circle cx='4' cy='4' r='4' fill='blue' opacity='.7'/></svg>") 4 4, auto}`;
	}
